    ...
    xx99MarkI: [
      {
        ...
        box: [
          { id: 1, times: 1, names: "Headphone Unit" },
          { id: 2, times: 2, names: "Replacement Earcups" },
    ...
    zx9: [
      {
        ...
        box: [
          { id: 1, times: 2, names: "Speaker Unit" },
          { id: 2, times: 2, names: "Speaker Cloth Panel" },
          { id: 3, times: 1, names: "User Manual" },
    ...
    yx1: [
      {
        ...
        box: [
          { id: 1, times: 2, names: "Earphone Unit" },
          { id: 2, times: 6, names: "Multi-size Earplugs" },
          { id: 3, times: 1, names: "User Manual" },
